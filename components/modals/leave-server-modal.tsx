...
const LeaveServerModal: FC = () => {
    ...
    const isOpenModal: boolean = isOpen && type === "leaveChannel";
    const {server} = data;
            ...
            <DialogContent className="bg-neutral-800 text-white p-0 overflow-hidden overflow-y-auto scrollbar-thin h-full md:h-auto">
                <DialogHeader className="pt-8 px-6">
                    ...
                    <DialogDescription className="text-center">
                        Are you sure you want to leave <span className="font-bold text-xl text-indigo-500">{server?.name}</span>?
                    </DialogDescription>
                </DialogHeader>
                <DialogFooter className="bg-gray-300 px-6 py-4">
                    <div className="flex items-center justify-between w-full">
                        <Button variant="ghost" className="font-semibold text-neutral-900" onClick={onClose} disabled={isLoading}>
                            Cancel
                        </Button>
